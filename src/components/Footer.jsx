                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
                        ...
                        <div className="col-span-1 md:col-span-2 lg:col-span-1 flex flex-col items-center md:items-start text-center md:text-left">
                            ...
                            {/* Redes Sociales con links actualizados */}
                            <div className="flex gap-4">
                                <a href="https://www.facebook.com/miderma.centrodelapiel" target="_blank" rel="noreferrer" aria-label="Facebook" className="bg-white/10 border border-white/30 text-[#FDF6F4] hover:bg-[#F2BDC7] hover:text-[#291840] hover:border-[#F2BDC7] w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1">
                                ...
                                <a href="https://www.instagram.com/miderma.centrodelapiel" target="_blank" rel="noreferrer" aria-label="Instagram" className="bg-white/10 border border-white/30 text-[#FDF6F4] hover:bg-[#F2BDC7] hover:text-[#291840] hover:border-[#F2BDC7] w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1">
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                                </a>
                                <a href="https://www.tiktok.com/@miderma.centrodel?is_from_webapp=1&sender_device=pc" target="_blank" rel="noreferrer" aria-label="TikTok" className="bg-white/10 border border-white/30 text-[#FDF6F4] hover:bg-[#F2BDC7] hover:text-[#291840] hover:border-[#F2BDC7] w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1">
                            ...
                            <div className="space-y-5 text-[#FDF6F4]/80 text-sm">
                                ...
                                <div className="flex items-start gap-3 group">
                                    ...
                                    <div className="flex flex-col gap-1 mt-1">
                                        {/* ENLACE Y TEXTO DE WHATSAPP ACTUALIZADOS */}
