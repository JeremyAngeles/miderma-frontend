                ...
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="w-full lg:w-1/2 flex justify-center relative px-4 lg:px-0">
                        ...
                        <img 
                            ...
                            className="w-full max-w-[320px] sm:max-w-[400px] lg:max-w-[580px] aspect-[4/5] object-cover rounded-[40px] border-[6px] sm:border-[8px] border-white shadow-2xl ring-4 ring-miderma-pink/30 lg:-translate-x-12"
                        />
                    </div>

                    {/* INFORMACIÓN CURRICULAR */}
                    <div className="w-full lg:w-1/2 text-center lg:text-left">
                        <span className="font-extrabold tracking-widest uppercase mb-3 block text-xs sm:text-sm text-miderma-purple opacity-80 font-Montserrat">
                        ...
                        <p className="text-base sm:text-lg leading-relaxed mb-8 opacity-90 text-gray-700 font-Montserrat">
