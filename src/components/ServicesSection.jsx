        ...
        <section className="py-24 px-4 sm:px-6 relative z-10 bg-white text-miderma-dark overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-wrap justify-center gap-6 lg:gap-8 mb-16 relative z-10">
                    ...
                    {/* APLICADO: rounded-none para que las esquinas sean totalmente en punta (cuadradas) */}
                    <div className="bg-white rounded-none overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_15px_50px_rgba(242,189,199,0.2)] transition-all duration-500 group border border-miderma-pink/10 hover:-translate-y-2 flex flex-col w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-22px)]">
                        ...
                        <div className="p-6 xl:p-8 flex flex-col flex-grow">
                            <p className="text-gray-600 mb-6 flex-grow text-sm xl:text-base leading-relaxed font-Montserrat">
                            ...
                            <ul className="space-y-3 mb-2 mt-auto font-Montserrat">
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Acné, rosácea y melasma.</li>
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Dermatopatías infantiles y autoinmunes.</li>
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Caída de cabello y hongos en uñas.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-none overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_15px_50px_rgba(242,189,199,0.2)] transition-all duration-500 group border border-miderma-pink/10 hover:-translate-y-2 flex flex-col w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-22px)]">
                        ...
                        <div className="p-6 xl:p-8 flex flex-col flex-grow">
                            ...
                            <ul className="space-y-3 mb-2 mt-auto font-Montserrat">
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Cáncer de piel (Melanoma y No Melanoma).</li>
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Extirpación de lunares y quistes.</li>
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Biopsias cutáneas precisas.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-none overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_15px_50px_rgba(242,189,199,0.2)] transition-all duration-500 group border border-miderma-pink/10 hover:-translate-y-2 flex flex-col w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-22px)]">
                        ...
                        <div className="p-6 xl:p-8 flex flex-col flex-grow">
                            ...
                            <ul className="space-y-3 mb-2 mt-auto font-Montserrat">
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Botox y Ácido Hialurónico.</li>
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Bioestimuladores y Mesoterapia.</li>
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Rejuvenecimiento láser e IPL.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-none overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_15px_50px_rgba(242,189,199,0.2)] transition-all duration-500 group border border-miderma-pink/10 hover:-translate-y-2 flex flex-col w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-22px)]">
                        ...
                        <div className="p-6 xl:p-8 flex flex-col flex-grow">
                            ...
                            <ul className="space-y-3 mb-2 mt-auto font-Montserrat">
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Dermatitis atópica y del pañal.</li>
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Sarpullido por calor e Infecciones.</li>
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Verrugas y Molusco Contagioso.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-none overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_15px_50px_rgba(242,189,199,0.2)] transition-all duration-500 group border border-miderma-pink/10 hover:-translate-y-2 flex flex-col w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-22px)]">
                        ...
                        <div className="p-6 xl:p-8 flex flex-col flex-grow">
                            ...
                            <ul className="space-y-3 mb-2 mt-auto font-Montserrat">
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Rutinas Skin Care y Peelings.</li>
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Limpieza profunda (Hydrofacial).</li>
                                <li className="flex items-start gap-2 text-sm xl:text-base text-gray-700"><span className="text-miderma-pink font-bold mt-0.5">✓</span> Dermapen y terapias Luz LED.</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="text-center relative z-10">
                    <Link to="/servicios" className="inline-flex items-center justify-center gap-3 bg-white border-2 border-miderma-dark text-miderma-dark hover:bg-miderma-dark hover:text-white px-8 py-4 rounded-full font-bold transition-all duration-300 shadow-md hover:shadow-xl text-lg w-full sm:w-auto group font-Montserrat uppercase tracking-wider">
