...
const ESTILOS_HERO = {
    titulo: "text-2xl sm:text-3xl lg:text-4xl mb-4 sm:mb-6", 
    subtitulo: "text-base sm:text-xl md:text-2xl mb-8 sm:mb-10", 
    ...
    return (
        <section className="w-full flex flex-col overflow-hidden bg-white">
            ...
            {/* ======================================================================================
                ...
                - min-h-[90vh] / min-h-screen: Hace que el banner sea más alto en tablets y PC.
                - justify-end: Obliga a que el contenido se pegue abajo en TODAS las resoluciones.
                - pb-20 / pb-32 / pb-40: Controla exactamente qué tan despegado está el texto del final.
            ====================================================================================== */}
            <div className="relative w-full min-h-[85vh] md:min-h-[95vh] lg:min-h-screen pb-20 md:pb-28 lg:pb-36 xl:pb-44 pt-40 flex flex-col justify-end bg-miderma-dark">
                ...
                {/* Degradado oscuro de ABAJO HACIA ARRIBA solo en celular */}
                ...
                {/* Degradado original de IZQUIERDA A DERECHA para PC y Tablet */}
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-8 w-full">
                    <div className="relative max-w-4xl text-left -ml-2 lg:-ml-6">
                        ...
                        <div className="invisible opacity-0">
                            <h1 className={`${ESTILOS_HERO.titulo} font-titulos font-bold leading-[1.2] uppercase tracking-tight`}>
                                NOSOTROS SOLUCIONAMOS TUS PROBLEMAS <br />DERMATOLÓGICOS.
                            </h1>
                            <span className={`${ESTILOS_HERO.subtitulo} font-subtitulos font-bold tracking-tight uppercase block`}>
                                Tecnología y experiencia al servicio de tu piel
                            </span>
                            <div className={`px-5 py-2.5 sm:px-6 sm:py-3 ${ESTILOS_HERO.boton} font-subtitulos font-bold tracking-tight w-max uppercase`}>
                                Reserva tu Cita
                            </div>
                        </div>
                        ...
                        {slides.map((slide, index) => (
                            ...
                            >
                                {/* TÍTULO */}
                                <h1 className={`${ESTILOS_HERO.titulo} font-titulos font-bold text-white leading-[1.2] drop-shadow-lg uppercase tracking-tight`}>
                                    {slide.title}
                                </h1>
                                
                                {/* SUBTÍTULO */}
                                <span className={`${ESTILOS_HERO.subtitulo} text-miderma-pink font-subtitulos font-bold tracking-tight uppercase block drop-shadow-md`}>
                                    {slide.subtitle}
                                </span>
                                
                                {/* BOTÓN */}
                                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-start">
                                    <Link to={slide.link} className={`bg-miderma-pink hover:bg-white text-miderma-dark hover:text-miderma-dark px-5 py-2.5 sm:px-6 sm:py-3 rounded-full font-subtitulos font-bold transition-all duration-300 shadow-lg flex items-center justify-center gap-2 ${ESTILOS_HERO.boton} tracking-tight w-max uppercase`}>
                                        {slide.buttonText}
                                    </Link>
                                </div>
                            </div>
            ...
            <div className="bg-white rounded-2xl shadow-[0_4px_25px_rgba(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgba(242,189,199,0.15)] p-6 md:p-8 flex flex-col items-center justify-center text-center gap-4 transition-all duration-500 group">
                ...
                <div>
                    {/* Número estático y de color morado oscuro */}
                    <h4 className="font-extrabold text-[#291840] text-3xl md:text-4xl mb-1">
                        +10
                    </h4>
                    <p className="text-[13px] md:text-sm font-bold text-[#615573] font-subtitulos tracking-tight uppercase">Años de Trayectoria</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-[0_4px_25px_rgba(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgba(242,189,199,0.15)] p-6 md:p-8 flex flex-col items-center justify-center text-center gap-4 transition-all duration-500 group">
                ...
                <div>
                    ...
                    <p className="text-[13px] md:text-sm font-bold text-[#615573] font-subtitulos tracking-tight uppercase">Pacientes Atendidos</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-[0_4px_25px_rgba(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgba(242,189,199,0.15)] p-6 md:p-8 flex flex-col items-center justify-center text-center gap-4 transition-all duration-500 group">
                ...
                <div>
                    ...
                    <p className="text-[13px] md:text-sm font-bold text-[#615573] font-subtitulos tracking-tight uppercase leading-tight">Pacientes recomiendan nuestros tratamientos</p>
                </div>
            </div>
