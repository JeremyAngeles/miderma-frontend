    ...
    return (
        <div className="border-b border-[#F2F2F2] last:border-0 py-4">
            <button onClick={() => setIsOpen(!isOpen)} className="w-full flex justify-between items-center text-left focus:outline-none group">
                {/* APLICADO: font-GFSDidot, uppercase, y text-xs md:text-sm igual que en Tratamientos */}
                <span className={`font-normal font-GFSDidot uppercase text-xs md:text-sm transition-colors pr-4 ${isOpen ? 'text-miderma-pink' : 'text-[#291840] group-hover:text-miderma-pink'}`}>
                    {pregunta}
                </span>
            ...
            <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isOpen ? 'max-h-[200px] opacity-100 pt-3' : 'max-h-0 opacity-0'}`}>
                <p className="text-sm text-[#615573] leading-relaxed pr-6 font-Montserrat">{respuesta}</p>
            </div>
        </div>
    );
};
...
const Contacto = () => {
    ...
    // =======================================================
    const numeroWhatsApp = "51940873814";
    ...
    // Estilo base para los inputs (Añadido font-Montserrat)
    const inputStyle = "w-full px-5 py-3.5 bg-[#F2F2F2]/60 border border-[#F2F2F2] rounded-xl text-[#291840] text-sm focus:bg-white focus:border-[#F2BDC7] focus:outline-none transition-colors shadow-sm font-Montserrat";
    const labelStyle = "text-[10px] font-bold text-[#615573] uppercase tracking-widest pl-2 mb-1.5 block font-Montserrat";

    return (
        <div className="w-full bg-white min-h-screen flex flex-col">
            <Navbar />

            {/* HERO DE CONTACTO (Ajustado espaciado, sin destello, sin línea rosada) */}
            <div className="relative w-full pt-28 md:pt-40 pb-16 bg-[#FDF6F4] flex flex-col items-center justify-center text-center px-4 overflow-hidden border-b border-[#F2F2F2]">
                <div className="relative z-10 flex flex-col items-center w-full max-w-4xl">
                    {/* Antetítulo rosado con la misma configuración global */}
                    ...
                    <h1 className="text-3xl md:text-5xl font-normal text-miderma-dark mb-4 font-GFSDidot uppercase">
                        Contacto
                    </h1>                    
            ...
            <section className="w-full py-16 md:py-24 px-4 sm:px-6 border-b border-[#F2F2F2]">
                <div className="max-w-[85rem] mx-auto flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
                    ...
                    <div className="w-full lg:w-5/12 flex flex-col lg:sticky lg:top-32">
                        ...
                        <div className="prose prose-p:text-[#615573] prose-p:leading-relaxed prose-p:mb-5 font-Montserrat">
                            <p>
                        ...
                        {/* Imagen referencial */}
                        <div className="mt-8 rounded-[2rem] overflow-hidden shadow-lg border-4 border-white relative hidden md:block">
                            <img
                                src="/reservarCitas.jpg"
                                alt="Reserva de cita"
                    ...
                    <div className="w-full lg:w-7/12">
                        <div className="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-[0_10px_40px_rgba(41,24,64,0.08)] border border-[#F2F2F2]">
                            <h3 className="text-xl font-normal text-[#291840] mb-2 font-GFSDidot uppercase">Formulario de Citas</h3>
                            <p className="text-[#9A92A6] text-sm mb-8 font-Montserrat">(Llene todos los campos por favor)</p>
                            ...
                            <form onSubmit={handleSubmitCita} className="flex flex-col gap-5">
                                ...
                                <button type="submit" className="w-full mt-4 bg-[#291840] hover:bg-[#F2BDC7] text-white hover:text-[#291840] py-4 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-2 text-sm uppercase tracking-widest font-bold font-Montserrat">
            ...
            {/* =========================================================
                SECCIÓN 2: TARJETAS DE INFORMACIÓN Y MAPA
            ========================================================= */}
                ...
                <div className="max-w-[85rem] mx-auto px-4 sm:px-6">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-8">
                        ...
                        <div className="bg-[#FDF6F4] p-4 sm:p-6 rounded-[1.5rem] sm:rounded-[2rem] border border-[#F2BDC7]/20 flex flex-col items-center text-center">
                            ...
                            <h4 className="font-normal text-[#291840] mb-1.5 sm:mb-2 font-GFSDidot uppercase text-sm sm:text-lg">Dirección</h4>
                            <p className="text-[10px] sm:text-sm text-[#615573] leading-relaxed font-Montserrat">Av. San Luis 2534, Oficina 701<br/>San Borja, Lima - Perú</p>
                        </div>
                        ...
                        <div className="bg-[#FDF6F4] p-4 sm:p-6 rounded-[1.5rem] sm:rounded-[2rem] border border-[#F2BDC7]/20 flex flex-col items-center text-center">
                            ...
                            <h4 className="font-normal text-[#291840] mb-1.5 sm:mb-2 font-GFSDidot uppercase text-sm sm:text-lg">Teléfono</h4>
                            <p className="text-[10px] sm:text-sm text-[#615573] leading-relaxed font-Montserrat">+51 940 873 814</p>
                        </div>
                        ...
                        <div className="bg-[#FDF6F4] p-4 sm:p-6 rounded-[1.5rem] sm:rounded-[2rem] border border-[#F2BDC7]/20 flex flex-col items-center text-center">
                            ...
                            <h4 className="font-normal text-[#291840] mb-1.5 sm:mb-2 font-GFSDidot uppercase text-sm sm:text-lg">Correo</h4>
                            <p className="text-[10px] sm:text-sm text-[#615573] leading-relaxed font-Montserrat">citas@miderma.pe</p>
                        </div>
                        ...
                        <div className="bg-[#FDF6F4] p-4 sm:p-6 rounded-[1.5rem] sm:rounded-[2rem] border border-[#F2BDC7]/20 flex flex-col items-center text-center">
                            ...
                            <h4 className="font-normal text-[#291840] mb-1.5 sm:mb-2 font-GFSDidot uppercase text-sm sm:text-lg">Horario</h4>
                            <p className="text-[10px] sm:text-sm text-[#615573] leading-relaxed font-Montserrat">Lunes a Sábado<br/>9:00 AM - 7:30 PM</p>
                        </div>
                    </div>

                    {/* BANNER DE REDES SOCIALES */}
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12 bg-[#FDF6F4] p-6 md:px-12 md:py-8 rounded-[2rem] border border-[#F2F2F2]">
                        <div className="text-center md:text-left">
                            <h4 className="font-normal text-[#291840] font-GFSDidot uppercase text-xl sm:text-2xl mb-1">Únete a nuestra comunidad</h4>
                            <p className="text-[#615573] text-sm font-Montserrat">Descubre tips, casos reales y novedades para cuidar tu piel.</p>
                        </div>
                        
                        <div className="flex gap-4">
                            <a href="https://www.facebook.com/miderma.centrodelapiel" target="_blank" rel="noreferrer" aria-label="Facebook" className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-[#291840] shadow-sm hover:bg-[#F2BDC7] hover:text-white hover:scale-110 hover:-translate-y-1 transition-all duration-300">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                                </svg>
                            </a>
                            <a href="https://www.instagram.com/miderma.centrodelapiel" target="_blank" rel="noreferrer" aria-label="Instagram" className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-[#291840] shadow-sm hover:bg-[#F2BDC7] hover:text-white hover:scale-110 hover:-translate-y-1 transition-all duration-300">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="https://www.tiktok.com/@miderma.centrodel?is_from_webapp=1&sender_device=pc" target="_blank" rel="noreferrer" aria-label="TikTok" className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-[#291840] shadow-sm hover:bg-[#F2BDC7] hover:text-white hover:scale-110 hover:-translate-y-1 transition-all duration-300">
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005 15.71a6.34 6.34 0 0010.86 4.43v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1-.1z"/>
                                </svg>
                            </a>
                        </div>
                    </div>
    ...
    <iframe
        src="https://maps.google.com/maps?q=Av.%20San%20Luis%202534,%20San%20Borja,%20Lima&t=&z=16&ie=UTF8&iwloc=&output=embed"
        width="100%"
        height="100%"
        style={{ border: 0 }}
        allowFullScreen=""
        ...
        title="Ubicación Miderma Av. San Luis 2534 San Borja"
    ></iframe>
</div>
